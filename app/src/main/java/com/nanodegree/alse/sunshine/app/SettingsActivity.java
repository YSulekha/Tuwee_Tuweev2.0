...
import com.nanodegree.alse.sunshine.app.sync.SunshineSyncAdapter;
...
public class SettingsActivity extends PreferenceActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            ...
            if (!com.nanodegree.alse.sunshine.app.Utility.isLocationLatLonAvailable(this)) {
    ...
    private void setPreferenceSummary(Preference preference, Object value) {
        ...
        if (preference instanceof ListPreference) {
            ...
            @SunshineSyncAdapter.LocationStatus int status = com.nanodegree.alse.sunshine.app.Utility.getLocationStatus(this);
            switch (status) {
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if ( key.equals(getString(R.string.pref_location_key)) ) {
            ...
            com.nanodegree.alse.sunshine.app.Utility.resetLocationStatus(this);
